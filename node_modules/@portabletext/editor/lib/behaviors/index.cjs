...
var behavior_core = require("../_chunks-cjs/behavior.core.cjs"), selector_isAtTheStartOfBlock = require("../_chunks-cjs/selector.is-at-the-start-of-block.cjs"), xstate = require("xstate"), selector_getTextBefore = require("../_chunks-cjs/selector.get-text-before.cjs"), types = require("@sanity/types"), util_isEmptyTextBlock = require("../_chunks-cjs/util.is-empty-text-block.cjs");
